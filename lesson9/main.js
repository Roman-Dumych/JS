...
// for (let ulListElement of mass) {
//     let li = document.createElement('li');
//     li.innerText = ulListElement;
...
// let body = document.querySelector('body');
// for (const simpsonsElement of simpsons) {
//     let div = document.createElement('div');
//     let h1 = document.createElement('h1');
...
//
//     h1.innerText = `${simpsonsElement.name}-${simpsonsElement.surname}`;
//     i.innerText = `Age:${simpsonsElement.age}`;
//     p.innerText = simpsonsElement.info;
//     img.setAttribute('src', simpsonsElement.photo)
//
...
// month.innerText = `monthDuration:${coursesElement.monthDuration}`;
// hour.innerText = `hourDuration:${coursesElement.hourDuration}`;
...
// div1.append(month, hour);
// div.append(title, div1, ul);
// body.append(div);
